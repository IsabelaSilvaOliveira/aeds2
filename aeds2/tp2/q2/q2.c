...
void formatVeiculo(Veiculo a, char* p){
	...
	sprintf(p,"[%d ## %s ## %s ## %d ## %s ## [%s] ## %d ## %f ## %s ## %s ## %f ## %f ## %f ## %s ## %s]",a.id,a.marca,a.modelo,a.ano,a.categoria,c,a.cilindros,a.cilindradas,a.transmissao,a.tracao,a.consumoCidade,a.consumoEstrada,a.co2,turbo,d);
